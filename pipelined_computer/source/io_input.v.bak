module io_input(addr,io_clk,io_read_data,in_port0,in_port1,in_port2);
	input [31:0] addr;
	input io_clk;
	...
	io_input_mux io_imput_mux2x32(in_reg0,in_reg1,in_reg2,addr[7:2],io_read_data);//根据addr，io_read_data选择哪一个端口数据
